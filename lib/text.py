...
_TERM_REPLACEMENTS: tuple[tuple[re.Pattern[str], str], ...] = (
    ...
    (re.compile(r"\btownsfordbushwalkingclub\.com\.au\b", re.IGNORECASE), "townsvillebushwalkingclub.com"),
    (re.compile(r"\btownsvillebushwalkingclub\.com\.au\b", re.IGNORECASE), "townsvillebushwalkingclub.com"),
    ...
    (re.compile(r"\bDavor\s+Falls\b", re.IGNORECASE), "Endeavour Falls"),
    ...
    (re.compile(r"\bNellie to Alma\b", re.IGNORECASE), "Nelly Bay to Alma Bay"),
    (re.compile(r"\bEarl and dense jungle\b", re.IGNORECASE), "all in dense jungle"),
    (re.compile(r"\bpersonal cater beacon\b", re.IGNORECASE), "personal locator beacon"),
    (re.compile(r"\bgarments are pretty good\b", re.IGNORECASE), "Garmin are pretty good"),
    (re.compile(r"\bChristian New Year's\b", re.IGNORECASE), "Christmas New Year's"),
    (re.compile(r"\bhunting field bath\b", re.IGNORECASE), "Huntingfield Bay"),
    (re.compile(r"\bHuntingfield bath\b", re.IGNORECASE), "Huntingfield Bay"),
    (re.compile(r"\bgold creek falls\b", re.IGNORECASE), "Gold Creek Falls"),
    (re.compile(r"\bcrystal falls\b", re.IGNORECASE), "Crystal Falls"),
    (re.compile(r"\bFox Lee\b", re.IGNORECASE), "Foxlee's"),
    (re.compile(r"\bGuards Lookout\b", re.IGNORECASE), "Gardes' Lookout"),
    (re.compile(r"\bPeterson Creek\b", re.IGNORECASE), "Petersen Creek"),
    (re.compile(r"\bEndeavor Road\b", re.IGNORECASE), "Endeavour Road"),
    (re.compile(r"\bdamn trail\b", re.IGNORECASE), "dam trail"),
    (re.compile(r"\bCompede\b", re.IGNORECASE), "Compeed"),
    (re.compile(r"\bGodwins\b", re.IGNORECASE), "Godwin's"),
    (re.compile(r"\bClean canteen\b", re.IGNORECASE), "Klean Kanteen"),
    (re.compile(r"\bLove's Bay\b", re.IGNORECASE), "Lovers Bay"),
    (re.compile(r"\bCali Falls\b", re.IGNORECASE), "Cowley Falls"),
    (re.compile(r"\bStoney Creek\b", re.IGNORECASE), "Stony Creek"),
    (re.compile(r"\bBamboo\b", re.IGNORECASE), "Bambaroo"),
